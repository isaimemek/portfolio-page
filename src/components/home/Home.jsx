...
const TextSection = (
  <div className="text-justify md:mr-36">
    <p className="text-indigo-900 dark:text-indigo-400 text-2xl md:text-4xl">
      <span className="font-bold font-mono">Hi, I'm Isa Imemek</span>
    </p>
    <p className="mt-2 text-pink-500 dark:text-pink-300 text-xl md:text-3xl">
      <span className="font-bold font-mono">I'm a Software Developer</span>
    </p>
    <p className="mt-6 italic md:text-lg md:font-medium dark:not-italic">
