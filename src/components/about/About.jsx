...
const TextSection = (
  <div className="text-justify md:mr-36">
    ...
    <br />
    <p className="italic md:text-lg md:font-medium">
    ...
    <div className="mt-16 text-xl text-center text-zinc-50 rounded ml-36 sm:ml-96 xl:ml-[500px]">
      <a
        rel="noreferrer"
        href={Resume}
        target="_blank"
        className="hover:outline outline-1 outline-red-300 bg-gradient-to-r from-emerald-400 to-teal-400 py-2 px-8"
      >
        Resume
      </a>
    </div>
